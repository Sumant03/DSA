...
//   public static int generateNumber(String str,HashMap<Character, Integer> charIntMap){
//       StringBuilder sb = new StringBuilder();
     
//       for(int i = 0 ; i < str.length() ; i++){
//           char ch = str.charAt(i);
//           int digit = charIntMap.get(ch);
//           sb.append(digit);
//       }
...
//                 int n1 = generateNumber(s1,charIntMap);
//                 int n2 = generateNumber(s2,charIntMap);
//                 int n3 = generateNumber(s3,charIntMap);
